...
ob_start();
  if ($this->errors) {
    foreach ($this->errors as $error) {
      echo '<div id="notice" class="alert-mfp alert-danger-mfp">'.$error.'</div>';
    }
  }
  if ($this->messages) {
    foreach ($this->messages as $message) {
      echo '<div id="notice" class="alert-mfp alert-success-mfp">'.$message.'</div>';
    }
  }
...
<div id="modalopen" class="modal-mfp">
 <div>
  <a href="#close" title="Закрыть" class="close-mfp">X</a>
  <p><?php echo __('Attention! All plugin settings will be reset permanently!', 'mfp-languages'); ?></p>
  <p><?php echo __('Are you sure you want to continue?', 'mfp-languages'); ?></p>
  <form method="post" action="" enctype="multipart/form-data" >
  <p><input type="submit" class="btn-mfp btn-danger-mfp" name="mfp-reset"
           value="<?php echo __('Yes, reset all settings', 'mfp-languages'); ?>" /></p>
  </form>
 </div>
</div>
...
<div class="metabox-holder container-mfp">
  <?php echo $notice; ?>
  <div class="sidebar1-mfp">
    <div class="postbox">
    ...
    <a class="btn-mfp btn-success-mfp" href="https://money.yandex.ru/to/410011517897625" target="_blank">
      <?php echo __('Donate to this plugin', 'mfp-languages'); ?></a>
    <a class="btn-mfp btn-danger-mfp" href="#modalopen"><?php echo __('Reset all settings', 'mfp-languages'); ?></a>
    <!--
    <div class="postbox">
      <h3 class="hndle">
  ...
  <div class="postbox">
    ...
    <div class="inside">
      ...
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Hide WordPress version in JavaScript and CSS:', 'mfp-languages'); ?>
      ...
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Removing the shortcut menu help:', 'mfp-languages'); ?>
      ...
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Removing the logo and links in wp admin panel:', 'mfp-languages'); ?>
      ...
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Disabling the function emoji:', 'mfp-languages'); ?>
          <p class="description"><?php echo __('Functional emoji (emoticons) can adversely affect site speed.', 'mfp-languages'); ?></p>
        </div>
        <div class="">
          <input type="checkbox" value="1" name="mfp_out_wp_emoji"
            <?php echo $this->mfp_options['mfp_mod_option_wp_emoji'] == '1'?'checked="checked" ':''; ?>/>
        </div>
      </div>
    </div>
  </div>
  <div class="postbox">
      ...
      <div class="inside">
        <div class="mfp-block clearfloat">
          <div class="h3-mfp"><?php echo __('Removing rss, rds:', 'mfp-languages'); ?>
      ...
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Removing wlwmanifest:', 'mfp-languages'); ?>
      ...
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Removing relink pages:', 'mfp-languages'); ?>
      ...
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Removes rel="canonical":', 'mfp-languages'); ?>
          <p class="description"><?php echo __('In some cases this can cause problems with indexing pages. Activate, if you know what you are doing.', 'mfp-languages'); ?></p>
        </div>
        <div class="">
          <input type="checkbox" value="1" name="mfp_out_link[rel_canonical]"
            <?php echo $this->mfp_options['mfp_mod_option_link']['rel_canonical'] == '1'?'checked="checked" ':''; ?>/>
        </div>
      </div>
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Removing wp_shortlink:', 'mfp-languages'); ?>
      ...
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Removing wp_generator:', 'mfp-languages'); ?>
  ...
  <div class="postbox">
      ...
      <div class="inside">
        <div class="mfp-block clearfloat">
          <div class="h3-mfp"><?php echo __('Remove widget Quick Press:', 'mfp-languages'); ?>
        ...
        <div class="mfp-block clearfloat">
          <div class="h3-mfp"><?php echo __('Remove widget Activity:', 'mfp-languages'); ?>
        ...
        <div class="mfp-block clearfloat">
          <div class="h3-mfp"><?php echo __('Remove widget Right now:', 'mfp-languages'); ?>
        ...
        <div class="mfp-block clearfloat">
          <div class="h3-mfp"><?php echo __('Remove widget News Wordpress:', 'mfp-languages'); ?>
        ...
        <div class="mfp-block clearfloat">
          <div class="h3-mfp"><?php echo __('Remove widget Welcome:', 'mfp-languages'); ?>
  ...
  <div class="postbox">
    ...
    <div class="inside mfp-translit">
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Enable transliteration:', 'mfp-languages'); ?>
  ...
  <div class="postbox">
    ...
    <div class="inside">
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Enable display text:', 'mfp-languages'); ?>
  ...
  <div class="postbox">
    ...
    <div class="inside mfp-box">
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Enable Metaboxes:', 'mfp-languages'); ?>
  ...
  <div class="postbox">
    ...
    <div class="inside">
      <div class="mfp-block clearfloat">
        <div class="h3-mfp"><?php echo __('Make beautiful:', 'mfp-languages'); ?>
    ...
    <input type="submit" class="btn-mfp btn-success-mfp" name="mfp-save"
